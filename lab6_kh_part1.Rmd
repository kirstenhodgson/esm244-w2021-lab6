...
well_duplicates <- sj_depth %>% 
  get_dupes(latitude, longitude) #Check for duplicate measurements at the same well

#Remove duplicates since there are only four
...
plot(sj_dgw_vgm, sj_dgw_vgm_fit) #Overall does a pretty good job
```
